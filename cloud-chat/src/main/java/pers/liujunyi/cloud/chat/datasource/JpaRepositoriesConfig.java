package pers.liujunyi.cloud.chat.datasource;
 ...
 */
@Configuration
@EntityScan(basePackages = {"pers.liujunyi.cloud.chat.entity"})
@EnableJpaRepositories(basePackages = {"pers.liujunyi.cloud.chat.repository.jpa"})
@EnableMongoRepositories(basePackages = {"pers.liujunyi.cloud.chat.repository.mongo"})
