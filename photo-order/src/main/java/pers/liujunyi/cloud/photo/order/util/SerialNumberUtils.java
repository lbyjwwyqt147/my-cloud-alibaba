...
public class SerialNumberUtils {
    ...
    public void clearCustomerNumber(){
        log.info("开始 清理 redis 中的 历史订单编号 start .......................... ");
        redisTemplateUtils.del(RedisKeys.ORDER_NUMBER + DateTimeUtils.getCurrentBeforeYear(1));
    }
    ...
    public  String getCurrentOrderNumber() {
        ...
        String currentKey = RedisKeys.ORDER_NUMBER + currentYear;
